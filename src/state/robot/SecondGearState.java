...
public class SecondGearState implements State {

    private Robot robot;

    public SecondGearState(Robot robot) {
        this.robot = robot;
    }
    ...
    public void downShift() {
        System.out.println("机器人降回一档");
        System.out.println("退出二档：Sound Siren");
        robot.setState(robot.getFirstGearState());
    }

    @Override
    public void upShift() {
        System.out.println("机器人已在二挡");
    }
